...
#define  HOURS_GROUP_MAX                  48   //组数     

#define  DEFAULT_S_CYCLE                  0xFFFF //默认schedule模式周期
     
//时间同步超时
#define  TIME_SYN_TIMEOUT                 4000
...
extern uint8_t Handel_ServerData_Schedule_Config(uint8_t* RxMessage, uint16_t dataLen);
...
extern void getRTC_Date_Time(void);
